-- team data insert
INSERT INTO team_tb (id, name, region, manager, stadium, logo) VALUES (team_tb_seq.nextVal, '기아타이거즈', '광주', '김기태', 'KIA챔피언스필드', null);
INSERT INTO team_tb (id, name, region, manager, stadium, logo) VALUES (team_tb_seq.nextVal, '넥센히어로즈', '서울', '염경엽', '목동종합운동장 야구장', null);
INSERT INTO team_tb (id, name, region, manager, stadium, logo) VALUES (team_tb_seq.nextVal, '두산베어스', '서울', '김태형', '잠실종합운동장 야구장', null);
INSERT INTO team_tb (id, name, region, manager, stadium, logo) VALUES (team_tb_seq.nextVal, '롯데자이언츠', '부산', '이종운', '부산사직구장', null);
INSERT INTO team_tb (id, name, region, manager, stadium, logo) VALUES (team_tb_seq.nextVal, '삼성라이온즈', '대구', '류중일', '대구시민운동장 야구장', null);
INSERT INTO team_tb (id, name, region, manager, stadium, logo) VALUES (team_tb_seq.nextVal, 'SK와이번스', '인천', '김용희', '인천SK행복드림구장', null);
INSERT INTO team_tb (id, name, region, manager, stadium, logo) VALUES (team_tb_seq.nextVal, 'NC다이노스', '창원', '김경문', '마산종합운동장 야구장', null);
INSERT INTO team_tb (id, name, region, manager, stadium, logo) VALUES (team_tb_seq.nextVal, 'LG트윈스', '서울', '양상문', '잠실종합운동장 야구장', null);
INSERT INTO team_tb (id, name, region, manager, stadium, logo) VALUES (team_tb_seq.nextVal, 'KT위즈', '수원', '조범현', '수원KT위즈파크', null);
INSERT INTO team_tb (id, name, region, manager, stadium, logo) VALUES (team_tb_seq.nextVal, '한화이글스', '대전', '김성근', '한화생명이글스파크 한밭야구장', null);
