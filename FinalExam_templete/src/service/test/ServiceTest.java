...
//		assertTrue(store.findTeam("10").getNumberOfPlayers() == 5);
//		assertTrue(store.findTeam("10").getPlayers().get(0).getName().equals("강경학"));
//	}
...
//	}
	...
	public void testTradePlayer() {
		...
		assertTrue(store.findPlayer("3").getTeamId().equals("6"));
