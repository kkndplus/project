...
, ARTIST_NAME VARCHAR(200) character set utf8
, ALBUM_TITLE VARCHAR(200) character set utf8
, IMAGE VARCHAR(300) 
, AGENT_NAME VARCHAR(200)character set utf8
, PRIMARY KEY (ID)
);
...
INSERT INTO USER_TB VALUES ('jin','1234', '진강사');
